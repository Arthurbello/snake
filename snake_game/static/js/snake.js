$(document).ready(function () {
    ...
    var food;
    var score;
    var highscore = $('#user').data('highscore');
    ...
    function gameLoop() {
        ...
        if(checkGameOver(nextPosition, snakeBody)) {
            ...
            canvasContext.fillText("GAME OVER", 87, height -150);
            canvasContext.font="15px Georgia";
            canvasContext.fillText("YOU'RE A SORE LOSER", 120, height -120);
            return;
        }
    ...
    function paintCanvas() {
       ...
       if (score > highscore) {
        ...
        var sscoreText = "HighScore: " + highscore;
        canvasContext.fillText(sscoreText, 310, height - 5);
    }
